...
const OrderCust = ({ setSelectedLink }) => {
  ...
  const processSubmit = (data) => {
    ...
    localStorage.setItem("kasirItems", JSON.stringify(orderData), { expires: 7 });
  };
                      ...
                      <td>
                        <button
                          ...
                          onClick={() => {
                            ...
                            // console.log("kuki manok", localStorage.getItem("kasirItems"))
                            // console.log("kuki json", JSON.parse(localStorage.getItem("kasirItems")))
                          }}
                        >
                          Process
                        </button>
