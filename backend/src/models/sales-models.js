...
const salesDetailSchema = new Schema({
  ...
  // id_store: { type: Schema.Types.ObjectId,
  //   ref: "store", },
  // id_company: { type: Schema.Types.ObjectId,
  //   ref: "company", },
  // id_user: { type: Schema.Types.ObjectId,
  //   ref: "user", },
  // id_item_campaign: { type: Schema.Types.ObjectId,
  //   ref: "item_campaign", },
...
const salesSchema = new Schema({
  ...
  id_sales_campaign: { type: Schema.Types.ObjectId, ref: "salesCampaign" },
  id_payment_type: { type: Schema.Types.ObjectId, ref: "payment_type" },
  tax: { type: Number, required: true },
  total_price: { type: Number, required: true },
  total_discount: { type: Number, required: true },
  total_quantity: { type: Number, required: true },
  total_number_item: { type: Number, required: true },
  status: { type: Number, enum: [1, 2], required: true },
